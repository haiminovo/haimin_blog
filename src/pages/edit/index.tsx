    ...
    return (
        <Layout>
            ...
            <Form className={style.edit__form}>
                ...
                <ReactQuillEditor className={style.form__quillEditor} value={value} onChange={debounce(handleChangeValue,500)}></ReactQuillEditor>
                <div className={style.form__buttonGroup}>
                <Button type="default" onClick={handleClickSubmit}>Primary Button</Button>
